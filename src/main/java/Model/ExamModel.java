...
import Controller.UserExamController.UserExam;
...
public class ExamModel {
    ...
    public static UserExam userExam;
    ...
    public static void addUserExam(Exam exam, User user) {

        String Query = "INSERT into User_Exam(user_id, exam_id) VALUES (" + "'" + exam.getId() + "'" + ", " + "'" + user.getId() + "'" + " ," + "'" + exam.getId() + "'" + ") ;";
        try {
            DBConnection.connection.createStatement().execute(Query);
    ...
    public int getUserExamExamId(UserExam userExam){
        int id = 0;
        ResultSet result;
        String str ="";
